(function() {
    ...
    var googStr = function() {return "What you see above you is a HEX code representing the current color of the canvas' background. \
    ...
    function Circle(x, y, radius, color, xVelocity, yVelocity, withStroke) {
        this.x = x;
        this.y = y;
        this.radius = radius;
        this.color = color;
    ...
    createButton("Change canvas color", function() {
    ...
    createButton("Random color", function() {
    ...
    createButton("Set the amount of circles", function() {
